...
Unresolved issues: 
- observers prior to 1999
- observer 2014 has entries where year, month and day is 0
- sentinel 2019, no data on Hd2
...
## observers
y.o <- read.card(sampling = "obs", year = 2015:2020, card = "age", species = 10) ## 1994:2014, 
...
Unresolved issues: 
- observers 2016, 2018 and 2019 are still not on Hd2
...
Remaining issues:
- are there really no commercial otoliths prior to 2018? 
...
for(yy in 2018:2021){ ## loop over years
  print(paste0("Year ",yy))
...
for(yy in c(1998:2019,2021)){ ## loop over years
  print(paste0("Year ",yy))
...
Outstanding issue:
- there are no ages in the bio cards
