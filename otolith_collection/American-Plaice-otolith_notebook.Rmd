...
TO DO 2023
commercial 2022 and 2023
observers 2022 and 2023
...
WHERE ARE THE COMMERCIAL SAMPLES FOR 2020, 2021 AND 2022?

```{r plaice, cache=TRUE}
## RV data
y <- read.card(species=40, card.type="bio", env="dev") #rv$bio[which(rv$bio$species==40),]
