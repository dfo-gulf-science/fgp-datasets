...
vars <- c("source", "latin.name_nom.latin", "english.name_nom.anglais", "french.name_nom.français", "year_année","month_mois","number.vertebrae_nombre.vertèbres","number.aged_nombre.agées")
o1 <- order(out.df$source, out.df$year_année, out.df$month_mois)
