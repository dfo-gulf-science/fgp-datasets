...
```{r sets}
survey = "sca"
yrs <- c(2012, 2013, 2014, 2015, 2016,2018)
...
fp  <- "E:/work/GitHub projects/fgp-datasets/scallop_survey/"
...
fgpheader <- c("year__annee","month__mois","day__jour","start_hour__heure_de_depart","start_minute__minute_de_depart","latitude","longitude","gear__equipement","species__espece","french_name__nom_francais","english_name__nom_anglais","latin_name__nom_latin","weight_caught__poids_pris","number_caught__quantite__attrape")
names(zz) = fgpheader
