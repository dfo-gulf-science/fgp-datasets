...
valid.cruise<-c('0901','O024','O139','O241','O341','O434','O536','O637','O030','O022','O029','O103','O129','O026','P126','P021','P521','P018','P024','P041', 'P140', 'P150', 'P151', 'P152')###only cruise numbers from July/August
...
```{r catch2}
### Catch card for all years requested (1971 - 2022)
