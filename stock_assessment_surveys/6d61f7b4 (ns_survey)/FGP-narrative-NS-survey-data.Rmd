...
```{r sets}
yrs <- 1999:2018 # only producing 2018 for the moment, will produce others years once we are sure data is in proper format
x <- read.card(card.type="set", year=yrs, survey =survey)
index <- x$experiment == 1
x <- x[which(index),]

valid.cruise<-c('0901','O024','O139','O241','O341','O434','O536','O637','O030','O022','O029','O103','O129','O026','P126','P021','P521','P018','P024','P041')###only cruise numbers from July/August
...
fp  <- "E:/work/GitHub projects/fgp-datasets/ns_survey/"
