...
valid.cruise<-c('0901','O024','O139','O241','O341','O434','O536','O637','O030','O022','O029',
                ...
                'P150', 'P151', 'P152', 'P303')###only cruise numbers from July/August
...
```{r catch2}
### Catch card for all years requested (1999 - 2023)
...
y[y$number.caught == 0,]$number.caught = NA # as per request by Natalie
